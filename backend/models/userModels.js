...
const userSchema =new mongoose.Schema({
    ...
    // Object type (not a nested schema) so existing consumers that only
    // read line1/line2 keep working unchanged — city/state/country/pincode
    // are additive keys on the same object.
    address:{type: Object, default:{line1: '', line2:'', city:'', state:'', country:'', pincode:''}},
